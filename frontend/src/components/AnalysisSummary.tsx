    ...
    <section className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.8fr)]" aria-label="Analysis evidence summary">
      <div className="rounded-xl border border-[#d4dfdc] bg-white p-5">
        <div className="flex items-center justify-between gap-3">
          <div><p className="font-mono text-xs uppercase tracking-[0.18em] text-[#147d78]">Evidence coverage</p><h2 className="mt-1 text-lg font-semibold text-[#17252f]">What informed this result</h2></div>
      ...
      <div className="rounded-xl border border-[#d4dfdc] bg-white p-5">
        <p className="font-mono text-xs uppercase tracking-[0.18em] text-[#a36d13]">Confidence notes</p>
        <h2 className="mt-1 text-lg font-semibold text-[#17252f]">Review before acting</h2>
